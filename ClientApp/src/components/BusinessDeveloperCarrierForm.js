...
export class BusinessDeveloperCarrierForm extends Component {
    static displayName = BusinessDeveloperCarrierForm.name;
        ...
        <div className="row">
            <div className="col-lg-7">
                <div className="content-block-header" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    Business Developer Executive<br>
                        </br> 
                ...
                <ul>
               <li type="circle" data-aos="fade-up" data-aos-duration="2000"> <p className="content-block-excerpt" data-aos="fade-up" data-aos-duration="2000">Must have good command on English.</p></li>
               <li type="circle" data-aos="fade-up" data-aos-duration="2000"> <p className="content-block-excerpt" data-aos="fade-up" data-aos-duration="2000">Effectively, converting the leads into prospective clients.</p></li>
               <li type="circle" data-aos="fade-up" data-aos-duration="2000"> <p className="content-block-excerpt" data-aos="fade-up" data-aos-duration="2000"> Handle multiple clients across the globle.</p></li>
               <li type="circle" data-aos="fade-up" data-aos-duration="2000"> <p className="content-block-excerpt" data-aos="fade-up" data-aos-duration="2000">  Creative and hard-working individual with the intent to take the <br></br>initiative to deliver the results.</p></li>
                </ul>
            </div>
